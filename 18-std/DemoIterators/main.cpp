...
int main() {
    ...
    //   ПРИМЕР: С помощью потокового итератора вывода обеспечить вывод числовой последовательности
    //   в файл и на дисплей. С помощью алгоритма copy вывести содержимое вектора на дисплей.
