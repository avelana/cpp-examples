...
//} global_lesson_variable {"Programming", "07.10.2019", "08:15", 521}; // Корректно, но не удобно
...
int main() {
  ...
  // Если при инициализации не будет присвоено значение члену, то ему присвоится значение по умолчанию,
  // если определено default value или 0, для чисел и "" для string, например
